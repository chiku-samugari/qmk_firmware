...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [BASE] = LAYOUT_arrow_command(
    ...
    MO(MOUSE), MO(AUXILIARY), KC_LALT, MO(SHIFT_NUM_AND_SYM),    KC_SPC,  KC_GRV,    KC_EQL, KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [NUM_AND_SYM] = LAYOUT_arrow_command(
     KC_ESC, _______,  KC_GRV,  KC_EQL, KC_MINS, _______, _______, _______, _______, _______, _______,  KC_DEL,
  ...
  [SHIFT_NUM_AND_SYM] = LAYOUT_arrow_command(
    _______, _______, _______, _______, _______, _______, _______, KC_TILD, KC_PLUS, KC_UNDS,  KC_ESC, KC_BSPC,
