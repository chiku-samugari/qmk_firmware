...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   ...
   [FOURTY_NUM_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______,    KC_1,    KC_2,    KC_3,    KC_4, _______,    KC_7,    KC_8, KC_MINS, _______, _______, KC_BSPC, _______,
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_LBRC, KC_AMPR, KC_ASTR, KC_UNDS,    KC_0, KC_RBRC, KC_BSPC, _______,
