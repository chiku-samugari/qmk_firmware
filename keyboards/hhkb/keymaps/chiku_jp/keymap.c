...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------------------------------------------------------------------------|
     * | Fn0| | Fn1|LGUI|LAlt|Fn12|  Space   | `  |  = |RAlt| Fn2| |Left|Down|Rght|
     * `--------------------------------------------------------------------------'
     */
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_LBRC, KC_RBRC, KC_AMPR, KC_ASTR, KC_UNDS,    KC_0, KC_BSPC, _______,
     KC_BSPC, _______,    KC_0,    KC_1, KC_LCBR, KC_PERC, KC_CIRC, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS,  KC_ENT, _______, _______,
     _______,    KC_2,    KC_3,    KC_4,    KC_5, _______,    KC_6,    KC_7,    KC_8,    KC_9, _______,  KC_DEL, _______, _______,
