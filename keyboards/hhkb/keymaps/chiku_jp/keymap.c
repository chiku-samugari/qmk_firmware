...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * LT(FOURTY_NUM_SYM, KC_GRAVE): Activates Fourty Numbers and
     * Symbols Layer on hold, issues KC_GRAVE on tap.
     *
     * ,--------------------------------------------------------------------------.
     ...
     * |--------------------------------------------------------------------------|
     * | Fn0| | Fn1|LGUI|Fn12|LAlt|  Space   |`/40|  = |RAlt| Fn2| |Left|Down|Rght|
     * `--------------------------------------------------------------------------'
     */
  ...
  [BASE] = LAYOUT_JP(
    ...
    KC_FN0, KC_FN1, KC_LGUI, KC_FN12, KC_LALT,         KC_SPC,     LT(FOURTY_NUM_SYM, KC_GRAVE), KC_EQL, KC_RALT,  KC_FN2, KC_LEFT, KC_DOWN, KC_RGHT
  ),
   ...
   * |    |    |    |    |    |    |    |    |    |    |    |    |    |    |    |
   * |--------------------------------------------------------------------------|
   * |  TAB |  1 |  2 |  3 |  4 |    |    |    |  7 |  8 |  - |BSpc|    |       |
   * |------------------------------------------------------------------\       |
   * |       |    |    |  0 |  [ |  5 |  6 |  ] |  9 |  0 |  - |Entr|    |      |
   * |--------------------------------------------------------------------------|
   * |        |  1 |  2 |  3 |  4 |  5 |  6 |  7 |  8 |    |    |Delet|    |    |
   * |--------------------------------------------------------------------------|
   * |    | |    |    |    |    |          |    |    |    |    | |    |    |    |
   * `--------------------------------------------------------------------------'
   */
   ...
   [FOURTY_NUM_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      KC_TAB,    KC_1,   KC_2,    KC_3,     KC_4, _______, _______,    KC_7,    KC_8, KC_MINS, _______, KC_BSPC, _______,
     _______, _______, _______,   KC_0, KC_LBRC,    KC_5,     KC_6, KC_RBRC,    KC_9,    KC_0, KC_MINS,  KC_ENT, _______, _______,
     _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8, _______, _______,  KC_DEL, _______, _______,
     _______, _______, _______, _______, _______,     _______     , _______, _______, _______, _______, _______, _______, _______
     ),
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, _______, _______, KC_AMPR, KC_ASTR,  KC_UNDS, KC_ESC, KC_BSPC, _______,
     _______, _______, _______,    KC_0, KC_LCBR, KC_PERC, KC_CIRC, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS,  KC_ENT, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,    KC_0, _______,  KC_DEL, _______, _______,
     _______, _______, _______, _______, _______,     _______     , _______, _______, _______, _______, _______, _______, _______
     ),
