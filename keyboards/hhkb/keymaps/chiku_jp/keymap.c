...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   ...
   [FOURTY_NUM_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______,    KC_1,    KC_2,    KC_3,    KC_4, _______,    KC_7,    KC_8, _______, KC_MINS, _______, KC_BSPC, _______,
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_LBRC, KC_AMPR, KC_ASTR,    KC_0, KC_UNDS, KC_RBRC, KC_BSPC, _______,
     _______, _______,    KC_1,    KC_0, KC_LCBR, KC_PERC, KC_CIRC, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS,  KC_ENT, _______, _______,
