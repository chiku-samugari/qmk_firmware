...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   ...
   [FOURTY_NUM_SYM] = KEYMAP_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      KC_ESC, _______, KC_GRV,   KC_EQL, KC_MINS, _______, _______, _______, _______, _______, _______,  _______, _______,
     _______, KC_BSLS, KC_QUOT, KC_LBRC, KC_RBRC,  KC_GRV,  KC_EQL, KC_SCLN,    KC_9,    KC_0, KC_MINS, _______, _______, _______,
     _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8, _______, _______, _______, _______, _______,
     _______, _______, _______, _______, _______,     _______     , _______, _______, _______, _______, _______, _______, _______
     ),
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = KEYMAP_JP(
     ...
     _______, KC_PIPE, KC_DQUO, KC_LCBR, KC_RCBR,  KC_GRV,  KC_EQL, KC_COLN, KC_LPRN, KC_RPRN, KC_MINS, _______, _______, _______,
