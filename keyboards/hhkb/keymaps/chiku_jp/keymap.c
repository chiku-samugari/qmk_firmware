...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_LBRC, KC_RBRC, KC_AMPR, KC_ASTR, KC_MINS,    KC_0, KC_BSPC, _______,
     KC_BSPC, _______,    KC_0,    KC_1, KC_LCBR, KC_PERC, KC_CIRC, KC_RCBR, KC_LPRN, KC_RPRN, KC_UNDS,  KC_ENT, _______, _______,
