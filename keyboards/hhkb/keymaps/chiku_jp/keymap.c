...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------------------------------------------------------------------------|
     * |L-Shift |  Z |  X |  C |  V |  B |  N |  M |  , |  . |  / |  \  |RSft|RSft|
     * |--------------------------------------------------------------------------|
     * | Fn0| | Fn1|LGUI|Fn12|LAlt|  Space   | `  |  = | Fn2|Left| |Down| Up |Rght|
     * `--------------------------------------------------------------------------'
     */
  ...
  [BASE] = LAYOUT_JP(
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_N,    KC_M,  KC_COMM,  KC_DOT, KC_SLSH, KC_BSLS, KC_RSFT, KC_RSFT,
    KC_FN0, KC_FN1, KC_LGUI, KC_FN12, KC_LALT,         KC_SPC,     KC_GRV, KC_EQL,    KC_FN2, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT
  ),
  ...
  [FIXED_RIGHT_PINKY_ON_JIS] = LAYOUT_JP(
    ...
    _______, _______, _______, _______, _______,   _______   ,S(KC_LBRC),S(KC_MINS), _______, _______, _______, _______, _______
  ),
  ...
  /* Layer Fourty Numbers and Symbols: 40% keybord symbols and numbers layer.
   *
   * ,--------------------------------------------------------------------------.
   * |    |    |    |    |    |    |    |    |    |    |    |    |    |    |    |
   * |--------------------------------------------------------------------------|
   ...
   */
   ...
   [FOURTY_NUM_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______,    KC_1,    KC_2,    KC_3,    KC_4, _______, _______,    KC_7,    KC_8, KC_MINS, _______, KC_BSPC, _______,
     _______, _______,    KC_1,    KC_0, KC_LBRC,    KC_5,    KC_6, KC_RBRC,    KC_9,    KC_0, KC_MINS,  KC_ENT, _______, _______,
     _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9, _______,  KC_DEL, _______, _______,
     _______, _______, _______, _______, _______,     _______     , _______, _______, _______, _______, _______, _______, _______
     ),
   ...
   */
   ...
   [FOURTY_SHIFT_SYM] = LAYOUT_JP(
     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_LBRC, KC_RBRC, KC_AMPR, KC_ASTR, KC_UNDS, KC_RBRC, KC_BSPC, _______,
     _______, KC_BSPC,    KC_1,    KC_0, KC_LCBR, KC_PERC, KC_CIRC, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS,  KC_ENT, _______, _______,
     _______, _______,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9, _______,  KC_DEL, _______, _______,
     _______, _______, _______, _______, _______,     _______     , KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______
     ),
