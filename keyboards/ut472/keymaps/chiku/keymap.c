...
[BASE] = LAYOUT(
  ...
  MO(MOUSE), MO(AUXILIARY), KC_LGUI, MO(SHIFT_NUM_AND_SYM), KC_FN0, KC_SPC, KC_GRV, KC_EQL, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[SHIFT_NUM_AND_SYM] = LAYOUT(
  ...
  _______, KC_BSPC,    KC_1,    KC_0, KC_LCBR, KC_PERC, KC_CIRC, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS,  KC_ENT,
